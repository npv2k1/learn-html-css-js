var NewComponent = React.createClass({
  render: function () {
    return (
      <div id="__next">
        <div className="homepage new-feed">
          <div className="container grid items-stretch grid-cols-12 gap-2 px-2 mx-auto md:gap-4 xl:grid-cols-8 2xl:px-5">
            <div className="z-40 col-span-12 md:col-span-9 lg:col-span-10 xl:col-span-7">
              <div className="w-full max-w-full">
                <div
                  className="bg-cover bg-center profile-cover border-l border-r dark:border-brand-grey-800 bg-white dark:bg-brand-grey-900"
                  style={{
                    backgroundImage:
                      'url("https://cdn.hashnode.com/res/hashnode/image/upload/v1584035951809/rA6njTVVd.jpeg?w=1600&fit=crop&crop=entropy&auto=compress&auto=compress")',
                  }}
                />
                <div className="pt-4 px-4 lg:px-16 bg-white dark:bg-brand-dark-grey-900 lg:border-l lg:border-r border-b dark:border-brand-grey-800 mb-4 rounded-bl-lg rounded-br-lg">
                  <div className="flex flex-row flex-wrap items-center">
                    <div className="w-24 h-24 mb-4 md:mb-0 md:-mt-40 flex-shrink-0 lg:mb-0 lg:w-40 lg:h-40 shadow-lg rounded-full md:mr-8 bg-white dark:bg-brand-grey-800 border-4 border-white dark:border-brand-grey-800 xl:ml-48">
                      <a
                        href="https://hashnode.com/@nguyen2k1io"
                        className="block w-full h-auto relative undefined"
                        data-title="false"
                      >
                        <img
                          data-sizes="auto"
                          loading="lazy"
                          src="https://cdn.hashnode.com/res/hashnode/image/upload/v1600792675173/rY-APy9Fc.png?w=400&h=400&fit=crop&crop=faces&auto=compress&auto=compress"
                          data-src="https://cdn.hashnode.com/res/hashnode/image/upload/v1600792675173/rY-APy9Fc.png?w=400&h=400&fit=crop&crop=faces&auto=compress&auto=compress"
                          data-width={400}
                          data-height={400}
                          alt="Nguyên Phạm's photo"
                          className="block w-full undefined block w-full rounded-full z-20 relative lazyautosizes lazyloaded"
                          sizes="152px"
                        />
                      </a>
                    </div>
                    <div className="pr-10 w-full md:flex-1 lg:w-auto">
                      <h1 className="text-3xl font-bold text-black dark:text-white leading-tight tracking-tight mb-2">
                        <a href="/@nguyen2k1io">Nguyên Phạm</a>
                      </h1>
                  ...
                  <div className="mt-12 text-sm flex flex-row items-center font-bold text-brand-grey-800 dark:text-brand-grey-400 justify-center uppercase tracking-wider overflow-auto">
                    <a
                      href="/@nguyen2k1io"
                      className="px-6 py-2 border-b-2 border-transparent hover:bg-brand-grey-100 dark:hover:bg-brand-grey-700 border-accent-blue-A700"
                    >
                      Profile
                    </a>
                    <a
                      href="/@nguyen2k1io/followers"
                      className="px-6 py-2 border-b-2 border-transparent hover:bg-brand-grey-100 dark:hover:bg-brand-grey-700 null"
                    >
                      Followers
                    </a>
                    <a
                      href="/@nguyen2k1io/following"
                      className="px-6 py-2 border-b-2 border-transparent hover:bg-brand-grey-100 dark:hover:bg-brand-grey-700 null"
                    >
                      Following
                    </a>
              ...
              <div className="flex flex-row items-start flex-grow-0 w-full max-w-full">
                <div className="flex-shrink-0 hidden w-84 xl:w-96 lg:block">
                  <div className="px-4 py-6 mb-5 bg-white border rounded-lg dark:bg-brand-dark-grey-900 dark:border-brand-grey-700">
                    <div className="mb-5">
                      <div className="flex flex-row items-center">
                        <a
                          href="/settings#moreAboutYou"
                          className="flex flex-row items-center mb-2 button-transparent small"
                        >
                          <svg
                      ...
                      <p className="mb-2 text-sm italic leading-snug text-brand-grey-600">
                        Looks like your bio is empty. Tell the world who you are
                        by writing a short description about you.
                      </p>
                    </div>
                    <div className="mb-2">
                      <span className="inline-block w-20 text-brand-grey-600">
                        Joined:{" "}
                      </span>
                      <span className="font-medium text-brand-grey-800 dark:text-brand-grey-400">
                        April 6, 2021
                      </span>
                    </div>
                    <div className="pt-5 mt-5 border-t dark:border-brand-grey-800">
                      <h2 className="mb-2 font-semibold text-brand-grey-700 dark:text-brand-grey-500">
                        I am available for
                      </h2>
                      <div className>
                        <div className="flex flex-row items-center">
                          <a
                            href="/settings#availableFor"
                            className="flex flex-row items-center mb-2 button-transparent small"
                          >
                            <svg
                              className="w-5 h-5 mr-2 fill-current"
                  ...
                  <div className="px-4 py-6 mb-5 bg-white border rounded-lg dark:bg-brand-dark-grey-900 dark:border-brand-grey-700">
                    <div className="flex flex-row">
                      <div className="w-1/3 p-2">
                        <h3 className="mb-px font-medium text-brand-grey-700 dark:text-brand-grey-500">
                          Followers
                        </h3>
                        <a
                          href="/@nguyen2k1io/followers"
                          title={0}
                          className="text-2xl font-bold text-brand-grey-800 dark:text-brand-grey-200"
                        >
                          0
                        </a>
                      </div>
                      ...
                      <div className="w-1/3 p-2">
                        ...
                        <p className="text-2xl font-bold text-brand-grey-800 dark:text-brand-grey-200">
                          0
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="px-4 py-6 mb-5 bg-white border rounded-lg dark:bg-brand-dark-grey-900 dark:border-brand-grey-700">
                    <h2 className="mb-4 text-xl font-medium text-brand-grey-700 dark:text-brand-grey-400">
                      My Tech Stack
                    </h2>
                    <div className="flex flex-row items-center">
                      <a
                  ...
                  <div className="px-4 py-6 mb-5 bg-white border rounded-lg dark:bg-brand-dark-grey-900 dark:border-brand-grey-700">
                    ...
                    <div className="widget-body recent-activity-body">
                      <div className="flex flex-row items-start mb-4">
                        <a
                          href="/@nguyen2k1io"
                          className="mt-2 mr-4 text-accent-blue-500"
                        >
                          <svg
                        ...
                        <div className="flex-1">
                          <p className="mb-1 text-base text-brand-grey-800">
                            Joined Hashnode
                          </p>
                          <p className="text-sm text-brand-grey-600">
                            <a href="/@nguyen2k1io">April 6, 2021</a>
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex-1 w-full max-w-full lg:w-auto lg:pl-5">
                  <div className="relative flex flex-col items-center p-8 mb-4 bg-white border rounded-lg dark:bg-brand-grey-900 dark:border-brand-grey-800">
                    ...
                    <h3 className="mb-3 text-xl font-semibold leading-snug text-brand-grey-700 dark:text-brand-grey-200">
                      Don't keep your new Hashnode profile a secret. Share it!
                    </h3>
                    <div className="flex flex-row items-center">
                      <a
                        href="https://twitter.com/intent/tweet?url=https://hashnode.com/@nguyen2k1io&text=I am in ❤️ with my Hashnode profile. Follow me here.&via=hashnode"
                        target="_blank"
                        className="flex flex-row items-center px-3 py-2 mr-2 text-white rounded-lg bg-twt-variant hover:opacity-75"
                      >
                        <svg
                          className="w-5 h-5 mr-2 fill-current"
                          viewBox="0 0 512 512"
                      ...
                      <a
                        href="https://www.facebook.com/dialog/share?app_id=176729339340246&href=https://hashnode.com/@nguyen2k1io&redirect_uri=https://hashnode.com"
                        target="_blank"
                        className="flex flex-row items-center px-3 py-2 text-white rounded-lg bg-fb-variant hover:opacity-75"
                      >
                        <svg
                          className="w-5 h-5 mr-2 fill-current"
                          viewBox="0 0 512 512"
                  ...
                  <div className="flex flex-col flex-grow-0 w-full pb-24">
                    <div className="post-card dark:bg-brand-grey-900 dark:border-brand-grey-800">
                      <div className="p-10 text-center card-content">
                        <h2 className="mb-4 text-xl text-gray-700 dark:text-gray-300">
                          There doesn't seem to be anything here!
                        </h2>
                        <img
                          className="block w-1/3 mx-auto my-20"
                          src="https://cdn.hashnode.com/res/hashnode/image/upload/v1578643371608/0EHh_xFuP.png?auto=compress"
                        />
                        <div className="flex flex-row justify-center">
                          <a href="/" className="text-lg hashnode-blue-button">
                            Go to feed
                          </a>
                        </div>
                      </div>
                    </div>
                    <div className="overflow-hidden border rounded-t-lg dark:border-brand-grey-800" />
                  </div>
                </div>
              </div>
            </div>
